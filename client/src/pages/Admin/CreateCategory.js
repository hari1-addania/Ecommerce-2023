...
const CreateCategory = () => {
  ...
  const handleDelete = async(id)=>{
    ...
    try {
      const {data} = await axios.delete(`${process.env.REACT_APP_API}/api/v1/category/delete-category/${id}`,{name:updatedName})
  ...
  <tbody>
      ...
      <button className='btn btn-danger ms-2' onClick={()=>{handleDelete(c._id)}} >Delete</button>
                   ...
                   <Modal onCancel={()=>setVisible(false)} foooter={null} visible={visible}> <CategoryForm value={updatedName} 
